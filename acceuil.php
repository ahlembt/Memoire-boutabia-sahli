...
<body>
    ...
    <div class="row">
        <div class="col-2">
            ...
            <P>Notre site vise à simplifier et à faciliter le processus d'achat, de vente,ou de construction pour les utilisateurs.
 <br> </P>
            <a href="Login.php" class="btn" style="font-size:15px;">Commencer &#8594;</a>
        </div>
        <div class="col-2">
